...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "check_join":
        if await is_subscribed(uid):
            ...
            await query.message.delete(); await start_cmd(client, query.message)
        ...
        await query.message.edit(f"Select Payment Method for {day} Day Plan:",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("💳 PAY WITH UPI", callback_data=f"pay_upi_{day}")],
